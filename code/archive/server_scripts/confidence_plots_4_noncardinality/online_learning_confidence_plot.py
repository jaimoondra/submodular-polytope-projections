...
for i in runs:
    time_df = pd.read_csv('times_4permutations_noncardinality_' + str(i) + '.csv', index_col=0,
                          header=None)
...
plt.savefig('runtime_1_shifted.png', dpi=300)
plt.show()
...
# plt.savefig('regret_1_shifted.png', dpi=300)
# plt.show()
