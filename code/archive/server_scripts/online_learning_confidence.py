...
def online_mirror_descent_permutahedron(P: Permutahedron, T: int, epsilon: float, seed):
    """
    ...
    # return total_time_cut_optimized, total_time_doubly_optimized, time_steps_cut_optimized, \
    #        time_steps_doubly_optimized, fw_iterations_cut_optimized, \
    #        fw_iterations_doubly_optimized, regret_cut_optimized, \
    #        regret_doubly_optimized
...
for seed in range(100, 110):
    ...
    times.to_csv('times_4permutations_' + str(seed) + '.csv')
    iterates.to_csv('iterates_4permutations_' + str(seed) + '.csv')
    regrets.to_csv('regrets_4permutations_' + str(seed) + '.csv')
