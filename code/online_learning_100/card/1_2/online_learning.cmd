...
arguments=$ENV(HOME)/online_learning_100/card/1_2/online_learning_permutahedron.py
log=online_learning_3.log
error=online_learning_3.error
output=online_learning_3.out
request_memory=5000
notification=error
