...
for i in runs:
    regret_df = pd.read_csv('moreregrets_3100 ' + str(i) + '.csv', index_col=0, header=None)
    regret_df.index = range(6)
    regret_df = regret_df.loc[[0, 1, 2, 3, 5]]
...
# average_i_plot, = plt.plot(average_i, color='magenta', label='Isotonic')
#
# plt.tight_layout()
#
# plt.legend(loc='lower right')
# plt.savefig('moreregret_50.png', dpi=300)
# plt.show()
#
